...
const char cc2_fan[6][2]    = { 3,1, 3,2, 1,2, 1,3, 2,1, 2,3 };	// Base三つ巴
...
fv_Step6()
/*
	減色ノードＢに対して、Ｂ - (Ｒ,Ｇ) (Ｇ,Ｒ) (Ｇ,Ｙ) (Ｙ,Ｇ) (Ｙ,Ｒ) (Ｒ,Ｙ)
	の６通りの三つ巴スワップを実施する。実施するスワップは、
	ルート変更不可に達した抜穴ノードが持つ三つ巴スワップ番号(mc_fan)に従う。
